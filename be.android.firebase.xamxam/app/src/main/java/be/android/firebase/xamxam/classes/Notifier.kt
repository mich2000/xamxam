...
data class Notifier(val context: Context, val DEFAULT_CHANNEL_ID:String, val DEFAULT_CHANNEL_NAME:String) {
    companion object{
         ...
         * **/
        fun defaultNotification(context: Context,textTitle:String, textContent:String) {
            val builder = NotificationCompat.Builder(context,context.getString(R.string.notify_products))
